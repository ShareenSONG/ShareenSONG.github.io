...
export default function WorkPage() {
  return (
    <main id="main-content" className="inner-page">
      ...
      <section className="work-index" aria-label="精选项目案例">
        {projects.map((project) => (
          <article className="work-index-card" key={project.slug}>
            <Link href={`/work/${project.slug}`} aria-label={`打开 ${project.title.zh}`} data-cursor="查看">
            ...
            <div className="work-index-copy">
              ...
              <h2><Link href={`/work/${project.slug}`} data-cursor="打开"><Copy value={project.title} /></Link></h2>
